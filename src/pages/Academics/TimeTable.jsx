  ...
  const btechPrograms = [
    {
      ...
      url: "/Data/Time-Table/I YR I SEM.pdf",
    ...
    },
    {
      ...
      url: "/Data/Time-Table/I YR II SEM.pdf",
      icon: "fa-solid fa-user-graduate",
      color: "#4e73df",
    },
    {
      ...
      url: "/Data/Time-Table/II YR I SEM.pdf",
    ...
    },
    {
      ...
      url: "/Data/Time-Table/II YR II SEM.pdf",
      icon: "fa-solid fa-laptop-code",
      color: "#1cc88a",
    },
    {
      title: "B.Tech",
      year: "III-I Year - 2024-25 - R22",
      url: "/Data/Time-Table/III YR I SEM.pdf",
      icon: "fa-solid fa-flask",
      color: "#f6c23e",
    },
    {
      title: "B.Tech",
      year: "III-II Year - 2024-25 - R22",
      url: "/Data/Time-Table/III YR II SEM.pdf",
      icon: "fa-solid fa-flask",
      color: "#f6c23e",
    },
    {
      title: "B.Tech",
      year: "IV-II Year - 2024-25 - R18",
      url: "/Data/Time-Table/IV YR I SEM.pdf",
    ...
    },
    {
      ...
      url: "/Data/Time-Table/IV YR II SEM.pdf",
      icon: "fa-solid fa-graduation-cap",
      color: "#e74a3b",
    },
  ];
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-8 text-center">
              <h1 className="header-title display-4 fw-bold">Time Tables</h1>
              <p className="text-white mt-3">
                Select your program to view timetables
              </p>
            </div>
          </div>
        </div>
